...
public abstract class AStrategy {
	...
	public Map<String/*category*/, HashMap<String, String>/*lastPubTime鍜宬eyword*/> lastPubMap = new HashMap<String, HashMap<String, String>>();
	...
	public AStrategy(String strategyName, IRepository repo) {
		...
		if(!isInitLock) {
			...
			//鏁版嵁搴撹璁′负鎸変笉鍚岀殑绫诲埆锛岃鍙杔astPubTime,鎸夋椂闂村�鎺掑簭
